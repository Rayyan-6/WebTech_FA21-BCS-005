    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        for (var i = 0; i < response.length; i++) {
          ...
          <div class="card border-success mb-3 mycard" style="max-width: 18rem" data-id="${rec.id}">
              ...
              <Button class="row btn btn-secondary editbtn">Edit</Button>
              <Button class="row btn btn-danger delbtn">Delete</Button>
              </div>
          </div>
